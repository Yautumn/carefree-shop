...
public class PurchaseInfo {
    ...
    public Integer getShopFactoryId() {
        return shopFactoryId;
    }

    public void setShopFactoryId(Integer shopFactoryId) {
        this.shopFactoryId = shopFactoryId;
    }
